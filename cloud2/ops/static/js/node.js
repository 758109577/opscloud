        ...
        init: function () {
            ...
            function saveRow(oTable, nRow) {
				...
				//提交数据，保存到数据库
					$.ajax({
						url: '/node_update/',
						type:"post",
						data:{'node_name':jqInputs[0].value,'node_ip':jqInputs[1].value,'code_dir':jqInputs[2].value,'create_user_id_id':jqInputs[3].value},
						dataType:"json",
			...
			function deleteEditRow(oTable, nRow) {
				...
				$.ajax({
                	url: '/node_delete/',
                    type:"post",
                    data:{'node_ip':jqInputs[1].innerText},
                    dataType:"json",
                    success:function(data){
                        return null
                    }
